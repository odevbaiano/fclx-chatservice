...
import (
	...
	"github.com/odevbaiano/fclx/chatservice/internal/domain/entity"
	"github.com/odevbaiano/fclx/chatservice/internal/domain/gateway"
...
func (uc *ChatCompletionUseCase) Execute(ctx context.Context, input ChatCompletionInputDTO) (*ChatCompletionOutputDTO, error) {
	...
	userMessage, err := entity.NewMessage("user", input.UseMessage, chat.Config.Model)
	if err != nil {
		return nil, errors.New("error creating user message: " + err.Error())
	}
	err = chat.AddMessage(userMessage)
	if err != nil {
		return nil, errors.New("error adding new messages: " + err.Error())
	}
	...
	if err != nil {
		return nil, errors.New("error add new message: " + err.Error())
	}
